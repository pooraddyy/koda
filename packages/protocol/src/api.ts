...
>(
  ...
  HttpApi.make("server")
    ...
    .add(makeSessionGroup(sessionLocationMiddleware, locationMiddleware)) // koda_change - provide configured location to session creation
    ...
    .annotateMerge(
      OpenApi.annotations({
        title: "koda HttpApi", // koda_change - public API grouping is koda-branded
        version: "0.0.1",
