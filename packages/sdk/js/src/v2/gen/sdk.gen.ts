...
import type {
  ...
  kodaAudioTranscriptionsErrors,
  kodaAudioTranscriptionsResponses,
  kodaAuthStatusErrors,
  kodaAuthStatusResponses,
  kodaClawChatCredentialsErrors,
  kodaClawChatCredentialsResponses,
  kodaClawStatusErrors,
  kodaClawStatusResponses,
  kodaCloudSessionGetErrors,
  kodaCloudSessionGetResponses,
  kodaCloudSessionImportErrors,
  kodaCloudSessionImportResponses,
  kodaCloudSessionsErrors,
  kodaCloudSessionsResponses,
  kodaAgentManagerListErrors,
  kodaAgentManagerListResponses,
  kodaAgentManagerRejectErrors,
  kodaAgentManagerRejectResponses,
  kodaAgentManagerReplyErrors,
  kodaAgentManagerReplyResponses,
  kodaBackgroundJobCancelErrors,
  kodaBackgroundJobCancelResponses,
  kodaBackgroundJobsErrors,
  kodaBackgroundJobsResponses,
  kodaCommandFilesErrors,
  kodaCommandFilesResponses,
  kodaHeapSnapshotErrors,
  kodaHeapSnapshotResponses,
  kodaNotebookListErrors,
  kodaNotebookListResponses,
  kodaNotebookRejectErrors,
  kodaNotebookRejectResponses,
  kodaNotebookReplyErrors,
  kodaNotebookReplyResponses,
  kodaProviderUsageGetErrors,
  kodaProviderUsageGetResponses,
  kodaProviderUsageRefreshErrors,
  kodaProviderUsageRefreshResponses,
  kodaRemoveAgentErrors,
  kodaRemoveAgentResponses,
  kodaRemoveCommandErrors,
  kodaRemoveCommandResponses,
  kodaRemoveSkillErrors,
  kodaRemoveSkillResponses,
  kodaSessionImportMessageErrors,
  kodaSessionImportMessageResponses,
  kodaSessionImportPartErrors,
  kodaSessionImportPartResponses,
  kodaSessionImportProjectErrors,
  kodaSessionImportProjectResponses,
  kodaSessionImportSessionErrors,
  kodaSessionImportSessionResponses,
  kodaSessionModelUsageErrors,
  kodaSessionModelUsageResponses,
  kodaEditErrors,
  kodaEditResponses,
  kodaFimErrors,
  kodaFimResponses,
  kodaModelsImagesErrors,
  kodaModelsImagesResponses,
  kodaModelsTranscriptionsErrors,
  kodaModelsTranscriptionsResponses,
  kodaModesErrors,
  kodaModesResponses,
  kodaNotificationsErrors,
  kodaNotificationsResponses,
  kodaOrganizationSetErrors,
  kodaOrganizationSetResponses,
  kodaProfileErrors,
  kodaProfileResponses,
  LocationRef,
  LspStatusErrors,
  LspStatusResponses,
  McpAddErrors,
...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new kodaClient()" to fix this error.`)
    }
    return instance
  }
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the koda system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the koda system.
   */
...
export class Capabilities extends HeyApiClient {
   ...
   *
   * Get experimental features enabled on the koda server.
   */
...
export class Console extends HeyApiClient {
   ...
   *
   * Persist a new active Console account/org selection for the current local koda state.
   */
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global koda configuration settings and preferences.
   */
   ...
   *
   * Update global koda configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the koda server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the koda system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all koda instances, releasing all resources.
   */
   ...
   * Upgrade koda
   *
   * Upgrade koda to the specified version or latest if not specified.
   */
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current koda configuration settings and preferences.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   *
   * Update koda configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get project rules
   *
   * List project instruction files used by koda and return their current contents.
   */
   ...
   * Update model state
   *
   * Patch TUI-compatible model selections shared with koda Console.
   */
...
export class Worktree extends HeyApiClient {
   ...
   * List worktrees
   *
   * List all git worktrees for the current project and whether koda manages them.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current koda instance, releasing all resources.
   */
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the koda system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with koda.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get current project
   *
   * Retrieve the currently active project that koda is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by koda.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all koda sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new koda session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific koda session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
...
export class Indexing extends HeyApiClient {
  ...
  /**
   * List koda embedding models
   *
   * Retrieve the embedding models available through the active koda account.
   */
...
export class Audio extends HeyApiClient {
   ...
   *
   * Proxy an audio transcription request to the koda Gateway
   */
...
export class Models extends HeyApiClient {
   ...
   *
   * List image-capable models from the koda Gateway OpenRouter passthrough
   */
  public images<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<kodaModelsImagesResponses, kodaModelsImagesErrors, ThrowOnError>({
   ...
   *
   * List transcription-capable models from the koda Gateway catalog
   */
  public transcriptions<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Organization extends HeyApiClient {
  /**
   * Update koda Gateway organization
   *
   * Switch to a different koda Gateway organization
   */
  public set<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
    ...
    return (options?.client ?? this.client).post<kodaOrganizationSetResponses, kodaOrganizationSetErrors, ThrowOnError>(
      {
...
export class Claw extends HeyApiClient {
  /**
   * Get kodaClaw instance status
   *
   * Fetch the user's kodaClaw instance status via the kodaClaw worker
   */
  public status<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
    ...
    return (options?.client ?? this.client).get<kodaClawStatusResponses, kodaClawStatusErrors, ThrowOnError>({
  ...
  /**
   * Get kodaClaw chat credentials
   *
   * Returns the bearer token and endpoint URLs the client uses to talk to the koda Chat worker and the Event Service. The bearer is the user's existing long-lived koda JWT — koda-chat and event-service both verify it directly with NEXTAUTH_SECRET, so no separate token mint is needed.
   */
...
export class Session3 extends HeyApiClient {
   ...
   * Get cloud session
   *
   * Fetch full session data from the koda cloud for preview
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      id: string
    ...
    return (options?.client ?? this.client).get<kodaCloudSessionGetResponses, kodaCloudSessionGetErrors, ThrowOnError>({
...
export class koda extends HeyApiClient {
  /**
   * Get koda Gateway profile
   *
   * Fetch user profile and organizations from koda Gateway
   */
  public profile<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<kodaProfileResponses, kodaProfileErrors, ThrowOnError>({
      url: "/koda/profile",
      ...options,
      ...params,
    })
  ...
  /**
   * Get koda authentication status
   *
   * Check whether a locally stored koda credential can authenticate Gateway requests
   */
  public authStatus<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<kodaAuthStatusResponses, kodaAuthStatusErrors, ThrowOnError>({
  ...
  public modes<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<kodaModesResponses, kodaModesErrors, ThrowOnError>({
      url: "/koda/modes",
      ...options,
      ...params,
    })
   ...
   * FIM completion
   *
   * Proxy a Fill-in-the-Middle completion request to the koda Gateway
   */
  public fim<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).sse.post<kodaFimResponses, kodaFimErrors, ThrowOnError>({
      url: "/koda/fim",
      ...options,
      ...params,
      headers: {
  ...
  public edit<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<kodaEditResponses, kodaEditErrors, ThrowOnError>({
      url: "/koda/edit",
      ...options,
      ...params,
      headers: {
  ...
  /**
   * Get koda notifications
   *
   * Fetch notifications from koda Gateway for CLI display
   */
  public notifications<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<kodaNotificationsResponses, kodaNotificationsErrors, ThrowOnError>({
   ...
   * Get cloud sessions
   *
   * Fetch cloud CLI sessions from koda API
   */
  public cloudSessions<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<kodaCloudSessionsResponses, kodaCloudSessionsErrors, ThrowOnError>({
...
export class kodaWorkspace extends HeyApiClient {
  /**
   * List command files
   *
  ...
  public removeSkill<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<kodaRemoveSkillResponses, kodaRemoveSkillErrors, ThrowOnError>(
      {
  ...
  public removeAgent<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<kodaRemoveAgentResponses, kodaRemoveAgentErrors, ThrowOnError>(
      {
...
export class Telemetry extends HeyApiClient {
   ...
   *
   * Forward a telemetry event to PostHog via koda-telemetry.
   */
...
export class Session4 extends HeyApiClient {
   ...
   *
   * Interrupt active execution owned by this koda process. Idle interruption is a no-op.
   */
...
export class kodaClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<kodaClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    kodaClient.__registry.set(this, args?.key)
  }
  ...
  private _koda?: koda
  get koda(): koda {
    return (this._koda ??= new koda({ client: this.client }))
  }

  private _kodaWorkspace?: kodaWorkspace
  get kodaWorkspace(): kodaWorkspace {
    return (this._kodaWorkspace ??= new kodaWorkspace({ client: this.client }))
  }
