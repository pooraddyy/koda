 ...
 * metadata. koda-hosted embedding catalog metadata is fetched from Cloud so the
...
export function normalizekodaModelId(modelId: string | undefined): string | undefined {
  return modelId
}
