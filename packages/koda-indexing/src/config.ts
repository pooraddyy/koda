...
export const IndexingConfig = z
  .object({
    ...
    koda: z
      ...
      .strict()
      .optional()
      .describe("koda-hosted embedding provider options"),
    openai: z
...
export const IndexingSchema = Schema.Struct({
  ...
  koda: Schema.optional(
    Schema.Struct({
      apiKey: Schema.optional(Schema.String),
      baseUrl: Schema.optional(Schema.String),
      organizationId: Schema.optional(Schema.String),
    }),
  ).annotate({ description: "koda-hosted embedding provider options" }),
...
export function toIndexingConfigInput(cfg: IndexingConfig | undefined): IndexingConfigInput {
  ...
  return {
    ...
    kodaApiKey: cfg?.koda?.apiKey,
    kodaBaseUrl: cfg?.koda?.baseUrl,
    kodaOrganizationId: cfg?.koda?.organizationId,
