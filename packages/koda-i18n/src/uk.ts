export const dict = {
  ...
  "provider.connect.kodaGateway.byok.prefix": "Для отримання додаткової статистики використання використовуйте ",
  ...
  "settings.providers.note.koda": "Доступ до 500+ моделей ШІ",
  ...
  "marketplace.install.about.mcp":
    "MCP-сервер надає koda додаткові інструменти для роботи із зовнішніми сервісами або локальними програмами.",
  "marketplace.install.about.agent": "Агент додає багаторазову роль із власними інструкціями та дозволами.",
  "marketplace.install.about.skill":
    "Навичка додає інструкції та ресурси для певних завдань, які koda може завантажити за потреби.",
  "marketplace.install.mcp.warning":
    "MCP-сервери можуть виконувати локальні команди або підключатися до зовнішніх сервісів. koda запитає дозвіл перед використанням їхніх інструментів, якщо ваші дозволи не дають змоги робити це автоматично.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Вимкніть знімки koda для цього проєкту. Ви втратите скасування/повторення для змін koda, але git продовжить відстежувати все.",
