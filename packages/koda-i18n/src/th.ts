export const dict = {
  ...
  "provider.connect.kodaGateway.byok.prefix": "สำหรับสถิติการใช้งานเพิ่มเติม โปรดใช้ ",
  "provider.connect.kodaGateway.byok.link": "BYOK ผ่าน koda's Gateway",
  "provider.connect.kodaGateway.byok.suffix": "",

  // Provider settings translations
  "settings.providers.group.recommended": "แนะนำ",
  "settings.providers.note.koda": "เข้าถึงโมเดล AI มากกว่า 500 รายการ",
  ...
  "marketplace.install.about.mcp":
    "เซิร์ฟเวอร์ MCP เพิ่มเครื่องมือให้ koda สำหรับทำงานกับบริการภายนอกหรือโปรแกรมในเครื่อง",
  "marketplace.install.about.agent": "เอเจนต์เพิ่มบทบาทที่นำกลับมาใช้ใหม่ได้พร้อมคำสั่งและสิทธิ์ของตนเอง",
  "marketplace.install.about.skill": "ทักษะเพิ่มคำสั่งและทรัพยากรเฉพาะงานที่ koda สามารถโหลดได้เมื่อจำเป็น",
  "marketplace.install.mcp.warning":
    "เซิร์ฟเวอร์ MCP สามารถเรียกใช้คำสั่งในเครื่องหรือเชื่อมต่อกับบริการภายนอกได้ koda จะขออนุญาตก่อนใช้เครื่องมือ เว้นแต่สิทธิ์ของคุณจะอนุญาตโดยอัตโนมัติ",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "ปิดสแน็ปช็อตของ koda สำหรับโปรเจกต์นี้ คุณจะสูญเสียการยกเลิก/ทำซ้ำสำหรับการเปลี่ยนแปลงของ koda แต่ git ยังคงติดตามทุกอย่าง",
