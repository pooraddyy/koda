...
export const dict = {
  ...
  "provider.connect.kodaGateway.byok.prefix": "For more usage stats, ",
  ...
  "settings.providers.note.koda": "Access 500+ AI models",
  ...
  "marketplace.install.about.mcp":
    "An MCP server gives koda additional tools for working with external services or local programs.",
  "marketplace.install.about.agent": "An agent adds a reusable role with its own instructions and permissions.",
  "marketplace.install.about.skill":
    "A skill adds task-specific instructions and resources that koda can load when needed.",
  "marketplace.install.mcp.warning":
    "MCP servers can run local commands or connect to external services. koda will ask for permission before using their tools unless your permissions allow them automatically.",
  ...
  // are still what the backend matches on (see packages/opencode/src/koda/plan-followup.ts).
  ...
  // packages/opencode/src/koda/snapshot/track.ts.
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Turn off koda's snapshots for this project. You will lose undo/redo of koda file changes, but git still tracks everything.",
