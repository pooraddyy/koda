export const dict = {
  ...
  "provider.connect.kodaGateway.byok.prefix": "Für weitere Nutzungsstatistiken ",
  "provider.connect.kodaGateway.byok.link": "BYOK via koda's Gateway",
  "provider.connect.kodaGateway.byok.suffix": " nutzen.",

  // Provider settings translations
  "settings.providers.group.recommended": "Empfohlen",
  "settings.providers.note.koda": "Zugriff auf 500+ KI-Modelle",
  ...
  "marketplace.install.about.mcp":
    "Ein MCP-Server stellt koda zusätzliche Werkzeuge für die Arbeit mit externen Diensten oder lokalen Programmen bereit.",
  ...
  "marketplace.install.about.skill":
    "Ein Skill fügt aufgabenspezifische Anweisungen und Ressourcen hinzu, die koda bei Bedarf laden kann.",
  "marketplace.install.mcp.warning":
    "MCP-Server können lokale Befehle ausführen oder eine Verbindung zu externen Diensten herstellen. koda fragt vor der Verwendung ihrer Werkzeuge um Erlaubnis, sofern Ihre Berechtigungen dies nicht automatisch erlauben.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "koda-Snapshots für dieses Projekt ausschalten. Rückgängig/Wiederherstellen für koda-Änderungen ist nicht mehr möglich, aber git verfolgt weiterhin alles.",
