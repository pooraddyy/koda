export const dict = {
  ...
  "provider.connect.kodaGateway.byok.prefix": "Para más estadísticas de uso, utiliza ",
  "provider.connect.kodaGateway.byok.link": "BYOK a través de koda's Gateway",
  "provider.connect.kodaGateway.byok.suffix": ".",

  // Provider settings translations
  "settings.providers.group.recommended": "Recomendados",
  "settings.providers.note.koda": "Acceso a más de 500 modelos de IA",
  ...
  "marketplace.install.about.mcp":
    "Un servidor MCP proporciona a koda herramientas adicionales para trabajar con servicios externos o programas locales.",
  "marketplace.install.about.agent": "Un agente añade un rol reutilizable con sus propias instrucciones y permisos.",
  "marketplace.install.about.skill":
    "Una habilidad añade instrucciones y recursos específicos para tareas que koda puede cargar cuando sea necesario.",
  "marketplace.install.mcp.warning":
    "Los servidores MCP pueden ejecutar comandos locales o conectarse a servicios externos. koda pedirá permiso antes de usar sus herramientas, a menos que tus permisos lo permitan automáticamente.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Apaga las instantáneas de koda para este proyecto. Perderás deshacer/rehacer de los cambios de koda, pero git seguirá rastreando todo.",
