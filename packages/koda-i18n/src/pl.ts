export const dict = {
  ...
  "provider.connect.kodaGateway.byok.prefix": "Aby uzyskać więcej statystyk użycia, użyj ",
  "provider.connect.kodaGateway.byok.link": "BYOK przez koda's Gateway",
  "provider.connect.kodaGateway.byok.suffix": ".",

  // Provider settings translations
  "settings.providers.group.recommended": "Polecane",
  "settings.providers.note.koda": "Dostęp do ponad 500 modeli AI",
  ...
  "marketplace.install.about.mcp":
    "Serwer MCP zapewnia koda dodatkowe narzędzia do pracy z usługami zewnętrznymi lub programami lokalnymi.",
  "marketplace.install.about.agent": "Agent dodaje rolę wielokrotnego użytku z własnymi instrukcjami i uprawnieniami.",
  "marketplace.install.about.skill":
    "Umiejętność dodaje instrukcje i zasoby dotyczące określonych zadań, które koda może wczytać w razie potrzeby.",
  "marketplace.install.mcp.warning":
    "Serwery MCP mogą uruchamiać lokalne polecenia lub łączyć się z usługami zewnętrznymi. koda poprosi o pozwolenie przed użyciem ich narzędzi, chyba że uprawnienia zezwalają na to automatycznie.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Wyłącz snapshoty koda dla tego projektu. Stracisz cofanie/przywracanie zmian koda, ale git nadal śledzi wszystko.",
