export const dict = {
  ...
  "provider.connect.kodaGateway.byok.prefix": "Daha fazla kullanım istatistiği için ",
  "provider.connect.kodaGateway.byok.link": "koda's Gateway üzerinden BYOK",
  "provider.connect.kodaGateway.byok.suffix": " kullanın.",

  // Provider settings translations
  "settings.providers.group.recommended": "Önerilen",
  "settings.providers.note.koda": "500+ AI modeline erişim",
  ...
  "marketplace.install.about.mcp":
    "Bir MCP sunucusu, harici hizmetler veya yerel programlarla çalışmak için koda'ya ek araçlar sağlar.",
  "marketplace.install.about.agent":
    "Bir ajan, kendi talimatları ve izinleri olan yeniden kullanılabilir bir rol ekler.",
  "marketplace.install.about.skill":
    "Bir yetenek, koda'nun gerektiğinde yükleyebileceği göreve özel talimatlar ve kaynaklar ekler.",
  "marketplace.install.mcp.warning":
    "MCP sunucuları yerel komutları çalıştırabilir veya harici hizmetlere bağlanabilir. İzinleriniz otomatik olarak izin vermediği sürece koda, araçlarını kullanmadan önce izin ister.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Bu proje için koda anlık görüntülerini kapat. koda değişiklikleri için geri alma/yeniden yapmayı kaybedersiniz, ancak git her şeyi izlemeye devam eder.",
