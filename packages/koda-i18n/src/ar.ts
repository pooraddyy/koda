export const dict = {
  ...
  "provider.connect.kodaGateway.byok.prefix": "للحصول على المزيد من إحصائيات الاستخدام، استخدم ",
  "provider.connect.kodaGateway.byok.link": "BYOK عبر koda's Gateway",
  "provider.connect.kodaGateway.byok.suffix": ".",

  // Provider settings translations
  "settings.providers.group.recommended": "موصى به",
  "settings.providers.note.koda": "الوصول إلى أكثر من 500 نموذج ذكاء اصطناعي",
  ...
  "marketplace.install.about.mcp": "يمنح خادم MCP منصة koda أدوات إضافية للعمل مع الخدمات الخارجية أو البرامج المحلية.",
  "marketplace.install.about.agent": "يضيف الوكيل دورًا قابلاً لإعادة الاستخدام بتعليماته وأذوناته الخاصة.",
  "marketplace.install.about.skill": "تضيف المهارة تعليمات وموارد خاصة بمهام معينة يمكن لـ koda تحميلها عند الحاجة.",
  "marketplace.install.mcp.warning":
    "يمكن لخوادم MCP تشغيل أوامر محلية أو الاتصال بخدمات خارجية. ستطلب koda الإذن قبل استخدام أدواتها ما لم تسمح أذوناتك بذلك تلقائيًا.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "أوقف لقطات koda لهذا المشروع. ستفقد ميزة التراجع/الإعادة لتعديلات koda، لكن git سيستمر في تتبع كل شيء.",
