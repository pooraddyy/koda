// koda-specific translations and overrides
// Keys here will override any matching keys from upstream translations
export const dict = {
  // koda Gateway provider translations
  "provider.connect.kodaGateway.byok.prefix": "Per ulteriori statistiche sull'utilizzo, utilizza ",
  "provider.connect.kodaGateway.byok.link": "BYOK tramite koda's Gateway",
  "provider.connect.kodaGateway.byok.suffix": ".",

  // Provider settings translations
  "settings.providers.group.recommended": "Consigliati",
  "settings.providers.note.koda": "Accesso a oltre 500 modelli AI",
  ...
  "marketplace.install.about.mcp":
    "Un server MCP fornisce a koda strumenti aggiuntivi per interagire con servizi esterni o programmi locali.",
  "marketplace.install.about.agent":
    "Un agente aggiunge un ruolo riutilizzabile con istruzioni e autorizzazioni proprie.",
  "marketplace.install.about.skill":
    "Una skill aggiunge istruzioni e risorse specifiche per un'attività che koda può caricare quando necessario.",
  "marketplace.install.mcp.warning":
    "I server MCP possono eseguire comandi locali o connettersi a servizi esterni. koda chiederà l'autorizzazione prima di usare i loro strumenti, a meno che le tue autorizzazioni non lo consentano automaticamente.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Disattiva gli snapshot di koda per questo progetto. Perderai annulla/ripeti sulle modifiche ai file fatte da koda, ma git continuerà a tracciare tutto.",
