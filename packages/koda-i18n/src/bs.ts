export const dict = {
  ...
  "provider.connect.kodaGateway.byok.prefix": "Za više statistika korištenja, koristite ",
  "provider.connect.kodaGateway.byok.link": "BYOK putem koda's Gateway",
  "provider.connect.kodaGateway.byok.suffix": ".",

  // Provider settings translations
  "settings.providers.group.recommended": "Preporučeno",
  "settings.providers.note.koda": "Pristup za 500+ AI modela",
  ...
  "marketplace.install.about.skill":
    "Vještina dodaje upute i resurse za određene zadatke koje koda može učitati kada su potrebni.",
  "marketplace.install.mcp.warning":
    "MCP serveri mogu pokretati lokalne naredbe ili se povezivati s vanjskim servisima. koda će zatražiti dozvolu prije korištenja njihovih alata, osim ako vaše dozvole to automatski dopuštaju.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Isključi koda snapshotove za ovaj projekat. Izgubićete poništi/vrati za izmjene koje napravi koda, ali git i dalje prati sve.",
