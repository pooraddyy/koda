export const dict = {
  ...
  "provider.connect.kodaGateway.byok.prefix": "Для получения дополнительной статистики использования используйте ",
  "provider.connect.kodaGateway.byok.link": "BYOK через koda's Gateway",
  "provider.connect.kodaGateway.byok.suffix": ".",

  // Provider settings translations
  "settings.providers.group.recommended": "Рекомендуемые",
  "settings.providers.note.koda": "Доступ к 500+ моделям ИИ",
  ...
  "marketplace.install.about.mcp":
    "MCP-сервер предоставляет koda дополнительные инструменты для работы с внешними сервисами или локальными программами.",
  ...
  "marketplace.install.about.skill":
    "Навык добавляет инструкции и ресурсы для определённых задач, которые koda может загрузить при необходимости.",
  "marketplace.install.mcp.warning":
    "MCP-серверы могут выполнять локальные команды или подключаться к внешним сервисам. koda запросит разрешение перед использованием их инструментов, если только ваши разрешения не допускают это автоматически.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Выключите снимки koda для этого проекта. Вы потеряете отмену/повтор изменений koda, но git по-прежнему отслеживает всё.",
