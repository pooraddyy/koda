...
describe("Gemini route", () => {
      ...
      const prepared = yield* LLMClient.prepare(
        LLM.request({
          ...
          messages: [
            ...
            Message.user("Summarize the result."), // koda_change - preserve Gemini role alternation
          ],
        }),
      )
        ...
        contents: [
          ...
          },
          {
            ...
            parts: [
              ...
              { text: "Summarize the result." }, // koda_change - coalesce adjacent user content
            ],
          },
        ],
        tools: [
  ...
  it.effect("strips matching data URLs to raw base64 inlineData", () =>
    Effect.gen(function* () {
      ...
      expect(prepared.body.contents).toEqual([
        // koda_change start - adjacent user-compatible content is coalesced
        {
          role: "user",
          parts: [
