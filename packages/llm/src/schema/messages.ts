...
export { StoredToolContent } from "@opencode-ai/schema/llm" // koda_change - shared with the durable event schema

// koda_change start - koda keeps a tolerant tool-result value union
