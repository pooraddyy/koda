...
const lowerMessages = Effect.fn("Gemini.lowerMessages")(function* (request: LLMRequest) {
  ...
  for (const message of request.messages) {
    if (message.role === "system") {
      ...
      ProviderShared.appendUserMessage(contents, { role: "user", parts: [{ text: part.text }] }, "parts") // koda_change
      continue
    }
    ...
    if (message.role === "user") {
      ...
      ProviderShared.appendUserMessage(contents, { role: "user", parts }, "parts") // koda_change
      continue
    }
