...
const lowerMessages = Effect.fn("AnthropicMessages.lowerMessages")(function* (
  ...
  for (const [index, message] of request.messages.entries()) {
    if (message.role === "system") {
      ...
      ProviderShared.appendUserMessage(messages, { role: "user", content: [block] }, "content") // koda_change
      continue
    }
    ...
    if (message.role === "user") {
      ...
      ProviderShared.appendUserMessage(messages, { role: "user", content }, "content") // koda_change
      continue
    }
