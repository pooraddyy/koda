...
import { ToastProvider } from "../../../../src/ui/toast" // koda_change
import { ExitProvider } from "../../../../src/context/exit" // koda_change
...
export async function mount(override?: FetchHandler, state?: string) {
        ...
        <KVProvider>
          ...
          <ToastProvider>
            ...
            <SDKProvider url="http://test" directory={directory} fetch={calls.fetch} events={events.source}>
              <PermissionProvider>
                <ProjectProvider>
                  {/* koda_change start - SyncProvider consumes the exit context */}
                  <ExitProvider exit={() => {}}>
                    <SyncProvider>
                      <Probe />
                    </SyncProvider>
  ...
  await ready
  await project.sync() // koda_change - event routing requires the resolved project
