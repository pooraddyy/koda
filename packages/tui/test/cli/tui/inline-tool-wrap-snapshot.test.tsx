...
const tools: readonly ToolFixture[] = [
  ...
  },
  {
    icon: "✱",
    label:
      'Grep "export const koda_DB|koda_DB|koda_DEV|Global\\.Path\\.data|data =" in packages/opencode/src (115 matches)',
  },
] as const
...
describe("TUI inline tool wrapping", () => {
  test("falls back for unknown tool names", () => {
    ...
    // koda_change start - koda tools keep their dedicated renderers
