import type { TuiPluginApi, TuiSlotContext, TuiSlotMap, TuiSlotProps } from "@koda/plugin/tui"
import { createSlot, createSolidSlotRegistry, type JSX, type SolidPlugin } from "@opentui/solid"
import { children, createSignal, mergeProps } from "solid-js" // koda_change
...
export function createSlots() {
  ...
  // koda_change start - keep stateful fallback children mounted while preserving reactive slot props
