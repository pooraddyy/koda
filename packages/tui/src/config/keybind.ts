...
export const Definitions = {
  ...
  "prompt.vim.toggle": keybind("none", "Toggle vim modal editing in the prompt input"), // koda_change
  ...
  news_toggle: keybind("none", "Toggle news on home screen"), // koda_change
...
export const CommandMap = {
  ...
  news_toggle: "news.toggle", // koda_change
