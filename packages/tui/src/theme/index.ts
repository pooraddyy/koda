...
import colorblind from "./assets/colorblind.json" with { type: "json" } // koda_change
...
import koda from "./assets/koda.json" with { type: "json" } // koda_change
import koda1 from "./assets/koda-v1.json" with { type: "json" } // koda_change
...
export function generateSystem(colors: TerminalColors, mode: "dark" | "light"): ThemeJson {
  ...
  const appBackground = isDark ? RGBA.fromHex("#0B1220") : RGBA.fromHex("#F5F7FA")
  ...
  return {
    theme: {
      ...
      // Background colors - use a stable app surface for consistent contrast
      ...
      markdownBlockQuote: ansiColors.cyan,
      markdownEmph: ansiColors.cyan,
      markdownStrong: fg,
