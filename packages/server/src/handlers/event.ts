...
import { kodaEvent } from "@opencode-ai/protocol/groups/event" // koda_change - encode the full koda event bus
...
function eventData(data: unknown): Sse.Event {
  return {
    ...
    event: "message",
    id: undefined,
    data: JSON.stringify(Schema.encodeUnknownSync(kodaEvent)(data)), // koda_change
  }
}
