/** Provider id and `koda.json` key (see https://atomic.chat and models.dev). */
...
export const LOG_PREFIX = "[@koda/plugin-atomic-chat]" as const

export const ATOMIC_CHAT_PLUGIN = "@koda/plugin-atomic-chat" as const
