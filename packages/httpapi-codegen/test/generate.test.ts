...
import { fileURLToPath } from "node:url" // koda_change - convert file URLs correctly on Windows
  ...
  it.effect("keeps the strict generated-consumer fixture current", () =>
    Effect.gen(function* () {
      ...
      const actual = yield* Effect.promise(
        () => Array.fromAsync(new Bun.Glob("*.ts").scan(fileURLToPath(new URL("generated", import.meta.url)))), // koda_change
      )
