...
export const SubtaskPart = Schema.Struct({
  ...
  variant: Schema.optional(Schema.String), // koda_change - preserve workflow subtask variant
...
// koda_change start - editor context captured by the VS Code client
...
const SessionRevert = Schema.Struct({
  ...
  workspace: optional(Schema.Literals(["restored", "snapshots-disabled", "unavailable"])), // koda_change
})
