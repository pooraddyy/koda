...
export const RunStatusState = Schema.Literals([
  "busy",
  "retrying",
  "offline",
  "interrupted",
...
export type RunStatusState = typeof RunStatusState.Type

export const RunStatusReason = Schema.Literals([
  "completed",
  "cancelled",
  "failed",
  "blocked",
...
export type RunStatusReason = typeof RunStatusReason.Type

export const RunStatus = Event.define({
  ...
  schema: {
    ...
    reason: optional(RunStatusReason),
...
export namespace Delegation {
  const BaseDelegation = {
    ...
    resumed: Schema.Boolean.pipe(optional),
  }
  export const Started = Event.define({
    type: "session.next.delegation.started",
    ...options,
    schema: BaseDelegation,
  })
  export type Started = typeof Started.Type
  export const Finished = Event.define({
    type: "session.next.delegation.finished",
    ...options,
    schema: {
      ...BaseDelegation,
      status: Schema.Literals(["completed", "failed", "cancelled", "blocked"]),
...
export namespace Compaction {
  ...
  export const Ended = Event.define({
    ...
    schema: {
      ...
      include: Schema.String.pipe(Schema.optional), // koda_change - released v1 readers recognize this compatibility field
      inputTokens: NonNegativeInt.pipe(Schema.optional),
      recentTokens: NonNegativeInt.pipe(Schema.optional),
      summaryTokens: NonNegativeInt.pipe(Schema.optional),
