...
const QuestionID = Schema.String.check(Schema.isStartsWith("que")).pipe(Schema.brand("QuestionID")) // koda_change
...
export const Info = Schema.Union([
  ...
  // koda_change start - represent a session paused for an offline koda question
  Schema.Struct({
