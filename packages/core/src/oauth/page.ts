...
// etc.).
//
// The visual language uses local semantic tokens and Koda wordmark geometry.
...
// Curated subset of local semantic tokens. Default is
...
// Koda wordmark geometry for the local OAuth page.
