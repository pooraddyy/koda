...
import * as EventStorage from "./koda/event-storage" // koda_change - released tool content shapes
...
const decodeSerializedEvent = (event: SerializedEvent): Payload => {
  ...
  return {
    ...
    data: Schema.decodeUnknownSync(definition.data)(EventStorage.decode(definition.type, event.data)), // koda_change
  }
}
...
export const readAggregate = Effect.fn("EventV2.readAggregate")(function* <A>(
  ...
  const events = page.map((event) => {
    ...
    return decode({
      ...
      data: EventStorage.decode(type, event.data), // koda_change
    })
  })
  return {
    events,
                    ...
                    .transaction(
                      () =>
                        Effect.gen(function* () {
                          ...
                          // koda_change - persist tool content in the released shape
