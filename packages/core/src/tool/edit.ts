 ...
 */
// koda_change - preserve named-reference mutation constraint documentation
...
import { ToolOutputStore } from "../tool-output-store" // koda_change
...
// koda_change start - keep durable/SSE tool records bounded without hiding normal-sized diff previews
      ...
      .register({
        [name]: Tool.withPermission(
          Tool.make({
            ...
            input: Input,
            output: Output,
            structured: Output, // koda_change
            toStructuredOutput: ({ output }) => compact(output), // koda_change
