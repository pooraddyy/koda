...
import { LocationMutation } from "../location-mutation" // koda_change
...
const layer = Layer.effectDiscard(
  Effect.gen(function* () {
    ...
    const mutation = yield* LocationMutation.Service // koda_change
        ...
        [name]: Tool.make({
          ...
          execute: (input, context) => {
            return Effect.gen(function* () {
              ...
              // koda_change - retain the approved filesystem identity through the read
