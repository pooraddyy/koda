...
export const defaultConfigLayer = Layer.sync(ConfigService, () =>
  ConfigService.of({
    provider:
      process.env.koda_WEBSEARCH_PROVIDER === "exa" || process.env.koda_WEBSEARCH_PROVIDER === "parallel"
        ? process.env.koda_WEBSEARCH_PROVIDER
        : undefined,
    enableExa: truthy("koda_EXPERIMENTAL") || truthy("koda_ENABLE_EXA") || truthy("koda_EXPERIMENTAL_EXA"),
    enableParallel: truthy("koda_ENABLE_PARALLEL") || truthy("koda_EXPERIMENTAL_PARALLEL"),
