...
import { RecallPartIndex } from "../koda/session/recall-part-index" // koda_change
...
export const SessionTable = sqliteTable(
  "session",
  {
    ...
    // koda_change - koda also persists a workspace restore status on the revert record
...
export const PartTable = sqliteTable(
  ...
  (table) => [
    ...
    RecallPartIndex.make(table), // koda_change
  ],
)
...
export const SessionMessageTable = sqliteTable(
  "session_message",
  {
    ...
    seq: integer(), // koda_change - allow released clients to share databases with newer schemas
    ...Timestamps,
