...
describe("v2 location HttpApi", () => {
  // koda_change start - malformed koda location headers are client errors
  ...
  test("streams native EventV2 payloads across locations", async () => {
    ...
    // koda_change start - the native handler must encode koda events omitted from upstream's narrower manifest
