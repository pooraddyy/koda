...
export function parseOptions(args: string[]): Options {
  ...
  return {
    ...
    // koda_change start - each shard owns an isolated DB already; --shard <index>/<total> lets the runner
...
// koda_change start - allow external (CI) callers to fan the exerciser out across N processes by index
