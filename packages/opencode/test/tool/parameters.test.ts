...
describe("tool parameters", () => {
  ...
  describe("shell", () => {
    ...
    // koda_change start - description is optional in koda (see bash.ts Parameters)
    test("accepts missing description (optional in koda)", () => {
  ...
  describe("grep", () => {
    ...
    // koda_change start - configurable grep signal controls
