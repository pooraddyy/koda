...
//
// Regression tests for https://github.com/koda-Org/koda/issues/9186
//
...
describe("kodaConfig.mergeConfig — custom provider model/variant deletion", () => {
  it("drops a model from an existing provider when the patch sets it to null", () => {
    ...
    const merged = kodaConfig.mergeConfig(existing, patch)
