...
import { defaultEndpoint, resolveEndpoint } from "@/koda/session-export/worker/endpoint"
...
describe("session export endpoint", () => {
  ...
  test("allows approved production endpoint", () => {
    const endpoint = "https://supermassive-black-hole.kodaapps.io/v1/session-export/batch"
