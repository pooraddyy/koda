...
import { environmentDetails } from "../../src/koda/editor-context"
...
import PROMPT_GPT55 from "../../src/session/prompt/koda-gpt-5.5.txt"
...
describe("environmentDetails", () => {
  test("includes cwd and worktree in dynamic context", () => {
    const result = environmentDetails({
      directory: "/repo/.koda/worktrees/feature",
      worktree: "/repo/.koda/worktrees/feature",
      activeFile: "src/app.ts",
    })

    expect(result).toContain("Working directory: /repo/.koda/worktrees/feature")
    expect(result).toContain("Workspace root folder: /repo/.koda/worktrees/feature")
