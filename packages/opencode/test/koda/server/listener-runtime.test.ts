...
const previous = {
  flag: Flag.koda_SERVER_PASSWORD,
  env: process.env.koda_SERVER_PASSWORD,
}

afterEach(async () => {
  Flag.koda_SERVER_PASSWORD = previous.flag
  if (previous.env === undefined) delete process.env.koda_SERVER_PASSWORD
  else process.env.koda_SERVER_PASSWORD = previous.env
