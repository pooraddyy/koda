...
it.instance(
  ...
  Effect.gen(function* () {
    ...
    yield* Effect.acquireUseRelease(
      ...
      () =>
        Effect.promise(async () => {
          Flag.koda_MODELS_URL = flags.source
          Flag.koda_MODELS_PATH = flags.path
          Flag.koda_DISABLE_MODELS_FETCH = flags.disabled
  ...
  { config: { disabled_providers: ["koda", "apertis"] } },
)
