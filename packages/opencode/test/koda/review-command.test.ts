...
import { legacyReviewMessage, parseReviewCommand, reviewCommand } from "../../src/koda/review/command"
...
describe("review command parsing", () => {
  test("parses every supported review invocation", () => {
    ...
    expect(parseReviewCommand("/review https://github.com/koda-Org/koda/pull/11084")).toBe("review")
