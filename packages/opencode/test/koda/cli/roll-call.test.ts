...
import { formatTable, formatMarkdown, handle, isTextModel, outputLimit } from "../../../src/koda/cli/cmd/roll-call"
...
describe("formatTable", () => {
  test("formats simple table correctly", () => {
    const rows = [
      ["koda/test-model", "YES", "Hello!", "1000ms"],
      ["koda/another-model", "NO", "(Error)", "500ms"],
    ]
