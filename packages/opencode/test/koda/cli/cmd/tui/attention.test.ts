...
import type { Event, Session, SessionNetworkWait, SuggestionRequest } from "@koda/sdk/v2"
import type { TuiAttentionNotifyInput } from "@koda/plugin/tui"
...
describe("koda attention TUI plugin", () => {
