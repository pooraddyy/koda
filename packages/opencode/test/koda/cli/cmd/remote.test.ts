...
// Shared helper lives in koda-sessions; remote.ts re-exports for the CLI path.
import { buildInstanceAdvertisement } from "../../../../src/koda-sessions/instance-advertisement"
