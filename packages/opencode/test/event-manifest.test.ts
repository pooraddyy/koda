...
describe("public event manifest", () => {
  test("contains every latest public wire type once", () => {
    ...
    expect(EventManifest.Latest.size).toBe(90) // koda_change - include global.config.updated and worktree.setup.ready
    ...
    expect(EventManifest.Latest.has("global.config.updated")).toBe(true) // koda_change
  })
