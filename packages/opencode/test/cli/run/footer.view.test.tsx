...
import { extend, testRender, useRenderer } from "@opentui/solid" // koda_change - register test components in this renderer instance
import { createSignal } from "solid-js"
import { createDefaultOpenTuiKeymap } from "@opentui/keymap/opentui"
import type { QuestionRequest } from "@koda/sdk/v2"
...
// koda_change start - keep renderer tests independent of the animated spinner's native teardown
...
test("direct subagent panel closes when moving up from the first item", async () => {
  ...
  try {
    ...
    // koda_change start - ctrl+p is the same navigation command as ArrowUp
...
// koda_change start - cover direct-mode koda skill picker transitions
    ...
    return (
      <OpencodeKeymapProvider keymap={keymap}>
        <RunFooterView
          ...
          onLayout={() => {}}
          onStatus={() => {}}
          onTerminalWrite={async () => {}} // koda_change
          onTerminalResize={async () => {}} // koda_change
          onTerminalClose={async () => {}} // koda_change
          onQueuedRemove={async () => true}
        />
      </OpencodeKeymapProvider>
    )
