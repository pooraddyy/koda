...
// koda_change start: rebrand fixtures off upstream repo path
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/koda-Org/koda.git")).toEqual({
    owner: "koda-Org",
    repo: "koda",
  })
})
...
test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/koda-Org/koda")).toEqual({ owner: "koda-Org", repo: "koda" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:koda-Org/koda.git")).toEqual({ owner: "koda-Org", repo: "koda" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:koda-Org/koda")).toEqual({ owner: "koda-Org", repo: "koda" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/koda-Org/koda.git")).toEqual({
    owner: "koda-Org",
    repo: "koda",
  })
})
...
test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/koda-Org/koda")).toEqual({ owner: "koda-Org", repo: "koda" })
})
// koda_change end
