...
// parseShareUrl tests
test("parses valid koda share URLs", () => {
  expect(parseShareUrl("https://app.koda.ai/s/7a755b04-b0fe-4e66-8b30-0ab52a181bd4")).toBe(
    "7a755b04-b0fe-4e66-8b30-0ab52a181bd4",
  )
  expect(parseShareUrl("https://app.koda.ai/s/Jsj3hNIW")).toBe("Jsj3hNIW")
  expect(parseShareUrl("https://app.koda.ai/s/test_id-123")).toBe("test_id-123")
  // koda_change start
  expect(
    parseShareUrl(
      "https://app.koda.ai/s/eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJzZXNfMTIzNDU2Nzg5MDEyMzQ1Njc4OTAxMiJ9.signature",
    ),
...
test("rejects invalid URLs", () => {
  expect(parseShareUrl("https://app.koda.ai/s/")).toBeNull()
  expect(parseShareUrl("https://app.koda.ai/s/id/extra")).toBeNull()
