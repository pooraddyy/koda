...
describe("installation", () => {
  describe("latest", () => {
    // koda_change start - curl/unknown fallback now resolves from the public npm
    ...
    testEffect(
      ...
      Effect.gen(function* () {
        ...
        expect(curlCalls).toContain("https://registry.npmjs.org/@koda-code%2fcli/local")
      }),
    )
    ...
    testEffect(
      ...
      Effect.gen(function* () {
        ...
        expect(npmCalls).toContain(`https://registry.npmjs.org/@koda-code%2fcli/${InstallationChannel}`) // koda_change
      }),
    )
    ...
    testEffect(
      ...
      Effect.gen(function* () {
        ...
        expect(bunCalls).toContain(`https://registry.npmjs.org/@koda-code%2fcli/${InstallationChannel}`) // koda_change
      }),
    )
    ...
    testEffect(
      ...
      Effect.gen(function* () {
        ...
        expect(pnpmCalls).toContain(`https://registry.npmjs.org/@koda-code%2fcli/${InstallationChannel}`) // koda_change
      }),
    )
    ...
    testEffect(
      testLayer(
        ...
        (cmd, args) => {
          ...
          if (cmd === "brew" && args.includes("--formula") && args.includes("koda-Org/tap/koda")) return "" // koda_change
          if (cmd === "brew" && args.includes("--formula") && args.includes("koda")) return "koda" // koda_change
          return ""
        },
      ),
    ...
    testEffect(
      testLayer(
        ...
        (cmd, args) => {
          if (cmd === "brew" && args.includes("koda-Org/tap/koda") && args.includes("--formula")) return "koda" // koda_change
