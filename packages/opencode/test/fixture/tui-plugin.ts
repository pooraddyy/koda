...
type Opts = {
  ...
  state?: {
    ...
    globalConfig?: HostPluginApi["state"]["globalConfig"] // koda_change
  ...
  return {
    ...
    attention: {
      ...
      soundboard: {
        ...
        current: () => opts.attention?.soundboard?.current?.() ?? "koda.default", // koda_change
    ...
    state: {
      ...
      session: {
        ...
        processes: opts.state?.session?.processes ?? (() => []), // koda_change
