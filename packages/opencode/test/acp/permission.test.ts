...
type PermissionReplyParams = Parameters<kodaClient["permission"]["reply"]>[0]
...
describe("acp permissions", () => {
  it("sends requestPermission and replies with the selected outcome", async () => {
    ...
    // koda_change start - human selections are marked interactive
  ...
  // koda_change start - skill shell batches surface their command list and cannot be persisted
