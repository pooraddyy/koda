...
const cache = process.env.koda_BWRAP_CACHE ?? path.join(os.tmpdir(), "koda-bubblewrap", commit)
...
#define PACKAGE_STRING "bubblewrap ${version} for koda"
...
koda distributes Bubblewrap as a separate executable. The complete license text is
