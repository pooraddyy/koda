  ...
  const profiles = {
    darwin: {
      ...
      groups: {
        filesystem: [
          "filesystem/*.test.ts",
          "koda/{external-directory-boundary,read-directory}.test.ts",
        ...
        runtime: [
          ...
          "koda/cli/install-artifact.test.ts",
          "koda/cli/tui/thread.test.ts",
          "koda/core-watcher.test.ts",
          "koda/interactive-terminal.test.ts",
          "tool/shell.test.ts",
          "util/{process,which}.test.ts",
        ],
        sandbox: ["koda/sandbox/*.test.ts"],
      },
    },
  } as const
