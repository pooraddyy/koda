// Per-tool display rules shared across `koda run` output paths. // koda_change
//
...
import type { ToolPart } from "@koda/sdk/v2"
...
import type { InteractiveTerminalTool } from "@/koda/tool/interactive-terminal" // koda_change
...
type ToolDefs = {
  ...
  interactive_terminal: typeof InteractiveTerminalTool // koda_change
