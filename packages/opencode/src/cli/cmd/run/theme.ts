...
import type { TuiThemeCurrent } from "@koda/plugin/tui"
...
export function generateSystem(colors: TerminalColors, pick: "dark" | "light"): ThemeJson {
  ...
  const appBackground = isDark ? rgba("#0B1220") : rgba("#F5F7FA")
  ...
  return {
    theme: {
      ...
      markdownBlockQuote: ansi.cyan,
      markdownEmph: ansi.cyan,
      markdownStrong: fg,
...
const seed = {
  ...
  warning: RGBA.fromIndex(6, rgba("#38D9C6")),
