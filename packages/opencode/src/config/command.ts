...
import { SchemaIssue } from "effect" // koda_change - preserve Effect issue details in koda warnings
...
export async function load(
  ...
  for (const item of await Glob.scan("{command,commands}/**/*.md", {
    ...
    await kodaConfig.handleInvalid("command", item, issues, cause, warnings)
    // koda_change end
  }
  return result
}
