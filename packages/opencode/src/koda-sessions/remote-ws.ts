...
export namespace RemoteWS {
  ...
  export type Options = {
    ...
    // koda_change - K1 W1: widened return type so the optional `instance`
        ...
        withContext(async () => {
          while (queued && !closed) {
            ...
            if (fresh !== undefined) {
              ...
              // koda_change - K1 W1: spread optional `instance` so the
              ...
              if (sentLive) {
                ...
                //
                // koda_change - K1 W1: a `detachSessionId` waiter
