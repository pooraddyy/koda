...
export namespace RemoteProtocol {
  ...
  export const SessionInfo = z.object({
    ...
    // koda_change - K1 W1: per-session platform advertises the platform the
    ...
    // koda_change - PR link: the pull request linked to the worktree this
  ...
  // koda_change - K1 W1: instance advertisement. Presence on a heartbeat
  ...
  export const Heartbeat = z.object({
    ...
    instance: InstanceAdvertisement.optional(), // koda_change - K1 W1
