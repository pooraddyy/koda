...
export const mcpHandlers = HttpApiBuilder.group(InstanceHttpApi, "mcp", (handlers) =>
  Effect.gen(function* () {
    ...
    // koda_change start - MCP Apps experimental resource/tool endpoints; logic lives in @/koda/mcp/apps
    ...
    return handlers
      ...
      .handle("readResource", readResource) // koda_change
      .handle("callTool", callTool) // koda_change
  }),
)
