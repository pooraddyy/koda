...
import { McpApps } from "@/koda/mcp/apps" // koda_change - MCP Apps schemas live in koda-owned code
...
export const McpPaths = {
  ...
  readResource: "/experimental/resource/read", // koda_change
  callTool: "/experimental/mcp/call-tool", // koda_change
} as const
  ...
  .add(
    HttpApiGroup.make("mcp")
      .add(
        ...
        // koda_change start - MCP Apps experimental endpoints
