...
export const DiffQuery = Schema.Struct({
  ...WorkspaceRoutingQueryFields,
  ...Struct.omit(SessionSummary.DiffInput.fields, ["sessionID", "full"]), // koda_change - full is a query boolean
  full: Schema.optional(QueryBoolean), // koda_change - request full-content detail
})
...
export const SessionPaths = {
  ...
  viewed: `${root}/viewed`, // koda_change
} as const
      ...
      .add(
        HttpApiEndpoint.get("list", SessionPaths.list, {
          ...
          OpenApi.annotations({
            ...
            description: "Get a list of all koda sessions, sorted by most recently updated.", // koda_change
          }),
        ),
        ...
        HttpApiEndpoint.get("get", SessionPaths.get, {
          ...
          OpenApi.annotations({
            ...
            summary: "Get session",
            description: "Retrieve detailed information about a specific koda session.", // koda_change
          }),
        ),
        ...
        HttpApiEndpoint.post("create", SessionPaths.create, {
          ...
          OpenApi.annotations({
            ...
            description: "Create a new koda session for interacting with AI assistants and managing conversations.", // koda_change
          }),
        ),
        ...
        HttpApiEndpoint.post("fork", SessionPaths.fork, {
          params: { sessionID: SessionID },
          query: WorkspaceRoutingQuery,
          payload: [HttpApiSchema.NoContent, ForkPayload], // koda_change - carry upstream bodyless full-session fork support
          success: described(Session.Info, "200"),
          error: [HttpApiError.BadRequest, ApiNotFoundError], // koda_change - carry upstream malformed payload response
        }).annotateMerge(
          OpenApi.annotations({
