...
import { Schema } from "effect" // koda_change
      ...
      .add(
        HttpApiEndpoint.get("get", root, {
          ...
          OpenApi.annotations({
            ...
            description: "Retrieve the current koda configuration settings and preferences.", // koda_change
          }),
        ),
        HttpApiEndpoint.patch("update", root, {
          ...
          OpenApi.annotations({
            ...
            description: "Update koda configuration settings and preferences.", // koda_change
          }),
        ),
        // koda_change start
