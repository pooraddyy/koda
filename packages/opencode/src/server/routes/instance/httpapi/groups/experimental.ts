...
export const ExperimentalPaths = {
  ...
  worktreeDiff: "/experimental/worktree/diff", // koda_change
  worktreeDiffFile: "/experimental/worktree/diff/file", // koda_change
  worktreeDiffSummary: "/experimental/worktree/diff/summary", // koda_change
      ...
      .add(
        ...
        HttpApiEndpoint.post("consoleSwitch", ExperimentalPaths.consoleSwitch, {
          ...
          OpenApi.annotations({
            ...
            description: "Persist a new active Console account/org selection for the current local koda state.",
          }),
        ),
        ...
        HttpApiEndpoint.get("worktree", ExperimentalPaths.worktree, {
          query: WorkspaceRoutingQuery,
          success: described(WorktreeList, "List of worktrees"), // koda_change
          error: WorktreeApiError,
        }).annotateMerge(
          OpenApi.annotations({
            identifier: "worktree.list",
            summary: "List worktrees",
            description: "List all git worktrees for the current project and whether koda manages them.", // koda_change
          }),
        ),
        ...
        HttpApiEndpoint.get("session", ExperimentalPaths.session, {
          ...
          OpenApi.annotations({
            ...
            description:
              "Get a list of all koda sessions across projects, sorted by most recently updated. Archived sessions are excluded by default.",
          }),
        ),
