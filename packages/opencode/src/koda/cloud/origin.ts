...
export const DEFAULT_CLOUD_AGENT_ORIGIN = "https://cloud-agent-next.kodasessions.ai"
export const DEFAULT_WEB_APP_ORIGIN = "https://koda.ai"
...
export function resolveWebAppOrigin(env: CloudEnvironment = process.env) {
  const value = env.koda_WEB_APP_URL
