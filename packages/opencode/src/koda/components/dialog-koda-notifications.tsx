/**
 * koda Notifications Dialog
 *
 * Displays all notifications from koda API in a scrollable dialog.
...
interface DialogkodaNotificationsProps {
  notifications: kodaNotification[]
}

export function DialogkodaNotifications(props: DialogkodaNotificationsProps) {
