/**
 * koda Gateway Organization Selection Dialog
 *
...
import { getOrganizationOptions, getDefaultOrganizationSelection } from "@koda/koda-gateway/tui"
...
interface DialogkodaOrganizationProps {
...
export function DialogkodaOrganization(props: DialogkodaOrganizationProps) {
    ...
    <DialogSelect
      ...
      onSelect={async (option: any) => {
        try {
          ...
          await sdk.client.koda.organization.set({
