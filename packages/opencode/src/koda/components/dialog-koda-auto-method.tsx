/**
 * Custom OAuth handler for koda Gateway
 *
...
import { DialogkodaOrganization } from "./dialog-koda-organization.js"
...
export function KodaAutoMethod(props: KodaAutoMethodProps) {
  ...
  onMount(async () => {
    try {
      ...
      const profileResponse = await sdk.client.koda.profile()
      ...
      console.warn("Failed to fetch koda profile, using personal account:", error)
      setStatus("error")
