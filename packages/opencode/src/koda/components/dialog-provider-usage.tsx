...
import type { ProviderUsage, ProviderUsageSnapshot } from "@koda/sdk/v2"
import { formatWindow, windowLabel } from "@koda/koda-gateway/provider-usage"
...
export function DialogProviderUsage() {
  ...
  async function load(force: boolean) {
    ...
    const response = await (force
      ? sdk.client.kodaWorkspace.providerUsage.refresh().catch(() => undefined)
      : sdk.client.kodaWorkspace.providerUsage.get().catch(() => undefined))
