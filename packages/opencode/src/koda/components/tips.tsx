...
const TIPS = [
  ...
  "koda can {highlight}configure itself{/highlight} if you ask it",
  "Ask koda to {highlight}add Supabase MCP globally{/highlight}",
  "Ask koda to {highlight}create a review agent for this project{/highlight}",
  "Ask koda to {highlight}add a plugin for desktop alerts{/highlight}",
  "Ask koda to {highlight}set Claude Sonnet as my default model{/highlight}",
  "Ask koda to {highlight}make my review agent read-only{/highlight}",
  "Ask koda to {highlight}require approval before git push{/highlight}",
  "Ask koda to {highlight}turn off auto-formatting{/highlight}",
  "Ask koda to {highlight}block access to .env files{/highlight}",
  "Ask koda to {highlight}turn off the F2 shortcut{/highlight}",
  "Ask koda to {highlight}match my terminal theme{/highlight}",
  "Ask koda to {highlight}disable sharing for all sessions{/highlight}",
  "Ask koda to {highlight}add rules from docs/ai-rules.md{/highlight}",
  "Ask koda to {highlight}enable tui.scroll_acceleration{/highlight} for smooth macOS-style scrolling",
  "Ask koda to {highlight}save this workflow as a /command{/highlight}",
  "koda auto-handles OAuth for remote MCP servers requiring auth",
  "koda auto-formats files using prettier, gofmt, ruff, and more",
  "koda uses LSP servers for intelligent code analysis",
