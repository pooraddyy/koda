...
class StateService extends Context.Service<StateService, State>()("@koda/AgentManager.State") {}
...
export class Service extends Context.Service<Service, Interface>()("@koda/AgentManager") {}
