...
import { SKILL_SHELL_DISABLED, SKILL_SHELL_UNTRUSTED } from "@/koda/skills/display"
...
// kill-switch (koda_DISABLE_SKILL_SHELL), and one batch bash ask naming every command
