...
import { isIndexingPlugin } from "@koda/koda-indexing/detect"
import { ensureAtomicChatPlugin, isAtomicChatPlugin } from "@/koda/atomic-chat-feature"
import { ensureIndexingPlugin, resolveIndexingPlugin } from "@/koda/indexing-feature"
...
export namespace kodaDefaultPlugins {
