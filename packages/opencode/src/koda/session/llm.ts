...
import { kodaSessionOverflow } from "./overflow"

const SAFETY = 2048
const MIN_OUTPUT = 1024

export namespace kodaLLM {
  ...
  export function capOutputTokens(input: {
    ...
    usage?: ReturnType<typeof kodaSessionOverflow.measure>
    reported?: number
  }): number | undefined {
    ...
    const estimated =
      ...
      kodaSessionOverflow.measure({ messages: input.messages, tools: input.tools }).normalized
