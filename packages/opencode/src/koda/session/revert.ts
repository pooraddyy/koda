...
export namespace kodaSessionRevert {
  ...
  export const apply = Effect.fn("kodaSessionRevert.apply")(function* <A, E, R>(
  ...
  export const restore = Effect.fn("kodaSessionRevert.restore")(function* (
    snap: Snapshot.Interface,
    hash: string,
    files: string[],
  ) {
