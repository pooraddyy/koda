...
const CloseReason = Schema.Literals(["completed", "error", "interrupted", "superseded", "budget"])

export const kodaSessionEvent = {
...
export type kodaSessionCloseReason = Schema.Schema.Type<typeof CloseReason>
