...
export namespace kodaCostPropagation {
  /**
   ...
   */
  export const childCost = Effect.fn("kodaCostPropagation.childCost")(function* (
   ...
   */
  export const propagate = Effect.fn("kodaCostPropagation.propagate")(function* (
    sessions: Session.Interface,
    sid: SessionID,
    mid: MessageID,
    amount: number,
