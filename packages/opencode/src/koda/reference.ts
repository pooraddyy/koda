...
// Keep Core V2 tools on the same effective koda config used by stable tools. Core's standalone
// scanner cannot see account/managed config or koda_CONFIG_CONTENT, so replace its provisional
// references after both config systems finish booting.
export const sync = Effect.fn("kodaReference.sync")(function* (input: {
