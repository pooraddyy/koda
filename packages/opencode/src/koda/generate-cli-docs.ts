...
const CLI_DOCS_DIR = root + "docs/"
const TABLE_PATH = CLI_DOCS_DIR + "cli-commands-table.md"
const REFERENCE_PATH = CLI_DOCS_DIR + "cli-reference.md"
...
// them here as well to keep koda.ai/docs in sync with the shipped binary.
...
description: "Complete reference for all koda CLI commands and subcommands"
---
