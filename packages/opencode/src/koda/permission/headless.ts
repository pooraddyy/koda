 ...
 * prompts (plain `koda run`). Permission asks originating from their child
...
export namespace kodaHeadless {
  ...
  export const denies = Effect.fn("kodaHeadless.denies")(function* (id: string) {
