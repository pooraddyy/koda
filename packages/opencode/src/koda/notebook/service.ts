...
class StateService extends Context.Service<StateService, State>()("@koda/NotebookState") {}
...
export class Service extends Context.Service<Service, Interface>()("@koda/Notebook") {}
