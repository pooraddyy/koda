...
type Client = {
  session: Pick<kodaClient["session"], "get">
  terminal: Pick<kodaClient["interactiveTerminal"], "write" | "resize" | "close">
}

export namespace kodaRunTerminal {
  export function create(sdk: kodaClient, session: () => string) {
