/**
 * Conversation selector for the kodaClaw chat.
 *
  ...
  return (
    <DialogSelect
      ...
      actions={[
        ...
        {
          command: "kodaclaw.conversation.new",
          title: "new",
          side: "right",
          onTrigger: async () => {
      ...
      bindings={[{ key: "ctrl+n", cmd: "kodaclaw.conversation.new" }]}
    />
  )
}
