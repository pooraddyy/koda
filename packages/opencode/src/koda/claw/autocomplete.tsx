/**
 * kodaClaw chat slash-command autocomplete.
 *
 ...
 * with kodaclaw's own `/new` for conversations.
 *
...
export function ClawAutocomplete(props: {
  ...
  useBindings(() => ({
    ...
    bindings: [
      { key: "up", desc: "Previous command", group: "kodaClaw", cmd: () => move(-1) },
      { key: "ctrl+p", desc: "Previous command", group: "kodaClaw", cmd: () => move(-1) },
      { key: "down", desc: "Next command", group: "kodaClaw", cmd: () => move(1) },
      { key: "ctrl+n", desc: "Next command", group: "kodaClaw", cmd: () => move(1) },
      { key: "escape", desc: "Hide autocomplete", group: "kodaClaw", cmd: hide },
      { key: "return", desc: "Select command", group: "kodaClaw", cmd: select },
      { key: "tab", desc: "Select command", group: "kodaClaw", cmd: select },
      {
        key: "right",
        fallthrough: true,
        cmd: () => {
