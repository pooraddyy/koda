 ...
 * and a textarea for chatting with the kodaClaw bot via koda Chat.
...
export function ClawChat(props: {
  ...
  // `bot:kodaclaw:{sandboxId}` — the bot is the only non-self member in 1:1
  // chats, so we resolve bot ids to the user-configured `botName` (which
  // falls back to "kodaClaw" upstream) and render any human collaborators
