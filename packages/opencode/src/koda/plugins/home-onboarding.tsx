import type { TuiPlugin, TuiPluginModule } from "@koda/plugin/tui"
import { createMemo, Show } from "solid-js"
import { Tips } from "@/koda/components/tips"
      ...
      home_bottom() {
        ...
        const connected = createMemo(() =>
          api.state.provider.some(
            (x) => (x.id !== "opencode" && x.id !== "koda") || Object.values(x.models).some((y) => y.cost?.input !== 0),
          ),
        )
