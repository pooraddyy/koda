import type { kodaSessionModelUsageResponse, Session, StepFinishPart } from "@koda/sdk/v2"

export type SessionModelUsage = kodaSessionModelUsageResponse
...
//
// When samples carry `elapsedMs` (koda_change: persisted on the
