...
import { fmtAttemptCost, fmtScore } from "@/koda/components/model-info-panel-utils"
import {
  aggregateMetrics,
  failed,
  formatCost,
  ...
  type StepMetrics,
  type UsageResult,
} from "@/koda/plugins/model-usage"
import { ModelRow, UsageRow } from "@/koda/plugins/sidebar-usage-row"

const id = "internal:koda-sidebar-usage"
...
function View(props: { api: TuiPluginApi; session_id: string }) {
  ...
  const [result, { refetch }] = createResource(
    ...
    (sessionID): Promise<UsageResult> =>
      props.api.client.kodaWorkspace.sessionModelUsage({ sessionID }).then(
