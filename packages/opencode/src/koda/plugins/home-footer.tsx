...
/**
 * koda-specific home footer plugin.
 *
...
import { RemoteIndicator } from "@/koda/remote-tui"

const id = "internal:koda-home-footer"

// ---------------------------------------------------------------------------
// Sub-components (mirror upstream home/footer with koda additions)
// ---------------------------------------------------------------------------
...
function View(props: { api: TuiPluginApi }) {
  const koda = createMemo(() => props.api.state.provider.some((p) => p.id === "koda"))
