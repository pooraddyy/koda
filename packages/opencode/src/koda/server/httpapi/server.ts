...
import * as AnacondaDesktop from "@/koda/anaconda-desktop/service"
import { EffectFlock } from "@opencode-ai/core/util/effect-flock"
import { AppNodeBuilderV1 } from "@/effect/app-node-builder-v1" // koda_change - defaultLayer aliases are gone
...
import { kodaGatewayHandlers } from "./handlers/koda-gateway"
import { kodaHandlers } from "./handlers/koda"
...
export function provideListener(opts?: CorsOptions) {
  ...
  return Layer.provide([
    ...
    fenceLayer,
    cors,
    kodaViewers.defaultLayer, // koda_change
