...
import { ReadyStatus, Status } from "@/koda/anaconda-desktop/domain"
...
const root = "/koda/anaconda-desktop"
      ...
      .add(
        ...
        HttpApiEndpoint.post("sync", AnacondaDesktopPaths.sync, {
          ...
          OpenApi.annotations({
            ...
            description:
              "Discover the active local inference server and replace koda provider authentication metadata.",
          }),
        ),
      )
      .annotateMerge(
