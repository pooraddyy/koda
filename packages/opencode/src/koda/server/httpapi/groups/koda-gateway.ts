...
export const kodaPassState = Schema.Struct({
...
export const ProfileWithBalance = Schema.Struct({
  ...
  kodaPass: Schema.NullOr(kodaPassState),
...
export const kodaGatewayApi = HttpApi.make("koda")
  .add(
    HttpApiGroup.make("koda")
      .add(
        HttpApiEndpoint.get("profile", kodaGatewayPaths.profile, {
          query: WorkspaceRoutingQuery,
          success: described(ProfileWithBalance, "Profile data"),
          error: [HttpApiError.BadRequest, HttpApiError.Unauthorized],
        }).annotateMerge(
          OpenApi.annotations({
            identifier: "koda.profile",
            summary: "Get koda Gateway profile",
            description: "Fetch user profile and organizations from koda Gateway",
          }),
        ),
        HttpApiEndpoint.get("authStatus", kodaGatewayPaths.authStatus, {
          query: WorkspaceRoutingQuery,
          success: described(AuthStatus, "koda authentication status"),
          error: HttpApiError.BadRequest,
        }).annotateMerge(
          OpenApi.annotations({
            identifier: "koda.authStatus",
            summary: "Get koda authentication status",
            description: "Check whether a locally stored koda credential can authenticate Gateway requests",
          }),
        ),
        HttpApiEndpoint.get("modes", kodaGatewayPaths.modes, {
          query: WorkspaceRoutingQuery,
          success: described(OrganizationModes, "Organization modes list"),
        }).annotateMerge(
          OpenApi.annotations({
            identifier: "koda.modes",
            summary: "Get organization custom modes",
            description: "Fetch custom modes defined for the current organization",
          }),
        ),
        HttpApiEndpoint.post("fim", kodaGatewayPaths.fim, {
          query: WorkspaceRoutingQuery,
          payload: FimBody,
        ...
        HttpApiEndpoint.post("edit", kodaGatewayPaths.edit, {
          query: WorkspaceRoutingQuery,
          payload: EditBody,
        ...
        HttpApiEndpoint.post("audioTranscriptions", kodaGatewayPaths.audioTranscriptions, {
          query: WorkspaceRoutingQuery,
        ...
        HttpApiEndpoint.get("cloudSessions", kodaGatewayPaths.cloudSessions, {
          query: {
            ...WorkspaceRoutingQueryFields,
          ...
          OpenApi.annotations({
            identifier: "koda.cloudSessions",
            summary: "Get cloud sessions",
            description: "Fetch cloud CLI sessions from koda API",
          }),
        ),
        HttpApiEndpoint.get("cloudSession", kodaGatewayPaths.cloudSession, {
          ...
          OpenApi.annotations({
            identifier: "koda.cloud.session.get",
            summary: "Get cloud session",
            description: "Fetch full session data from the koda cloud for preview",
          }),
        ),
        HttpApiEndpoint.post("cloudSessionImport", kodaGatewayPaths.cloudSessionImport, {
          query: WorkspaceRoutingQuery,
          ...
          OpenApi.annotations({
            identifier: "koda.cloud.session.import",
      ...
      .annotateMerge(
        OpenApi.annotations({
          title: "koda",
          description: "koda Gateway routes.",
        }),
      )
