...
import { MemoryContract } from "@koda/koda-memory/effect/httpapi"
...
import { MemoryApiClientError, MemoryApiServerError } from "@koda/koda-memory/effect/errors"
  ...
  .add(
    HttpApiGroup.make("memory")
      ...
      .annotateMerge(
        OpenApi.annotations({
          title: "memory",
          description: "koda memory routes.",
        }),
      )
