...
const root = "/koda/session-import"

const ResultSchema = Schema.Struct({
  ok: Schema.Boolean,
  id: Schema.String,
  skipped: Schema.optional(Schema.Boolean),
}).annotate({ identifier: "kodaSessionImportResult" })
    ...
    HttpApiGroup.make("session-import")
      .add(
        HttpApiEndpoint.post("project", SessionImportPaths.project, {
          ...
          OpenApi.annotations({
            identifier: "koda.sessionImport.project",
        ...
        HttpApiEndpoint.post("session", SessionImportPaths.session, {
          ...
          OpenApi.annotations({
            identifier: "koda.sessionImport.session",
        ...
        HttpApiEndpoint.post("message", SessionImportPaths.message, {
          ...
          OpenApi.annotations({
            identifier: "koda.sessionImport.message",
        ...
        HttpApiEndpoint.post("part", SessionImportPaths.part, {
          ...
          OpenApi.annotations({
            identifier: "koda.sessionImport.part",
      ...
      .annotateMerge(
        OpenApi.annotations({
          ...
          description: "koda legacy session import routes.",
        }),
      )
