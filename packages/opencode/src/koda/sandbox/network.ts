...
import { assertNetwork, assertSandbox, networkHttpLayer } from "@koda/sandbox"
import { host, opaque } from "./network-tools"

const Builtin = Symbol("koda.sandbox.builtinTool")
const Remote = Symbol("koda.sandbox.remoteMcp")
