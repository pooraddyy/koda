import { koda_API_BASE } from "./api/constants.js"
...
export type EditTarget =
  ...
  | { provider: "koda"; model: string; url: string }
...
const koda_NEXTEDIT_URL = koda_API_BASE + "/api/edit/completions"

/**
 * Pick the upstream edit endpoint for a (provider, model) pair. Today this is
 * either Inception's `/v1/edit/completions` (direct BYOK) or the koda Gateway's
