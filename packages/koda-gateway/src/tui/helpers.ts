/**
 * TUI-specific helper functions for koda Gateway integration
 *
...
import type { kodaProfile, kodaBalance, Organization } from "../types.js"
...
export function formatProfileInfo(
  ...
  const usageUrl = currentOrgId
    ? `https://app.koda.ai/organizations/${currentOrgId}/usage-details`
