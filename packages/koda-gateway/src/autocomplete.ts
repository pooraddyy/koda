export type AutocompleteProviderID = "koda" | "mistral" | "inception"
export type DirectAutocompleteProviderID = Exclude<AutocompleteProviderID, "koda">
...
interface AutocompleteModelBase {
  ...
  /** Provider key to use for direct BYOK. Empty means koda Gateway. */
...
export type AutocompleteModelDef = AutocompleteModelBase &
  (
    | {
        /** Route through `/koda/edit` using the Next Edit pipeline. */
        readonly kind: "edit"
...
const models: AutocompleteModelDef[] = [
  {
    id: "koda/mistralai/codestral-2508",
    modelID: "mistralai/codestral-2508",
    label: "Codestral",
    providerID: "koda",
    provider: "koda Gateway",
    requestModel: "mistralai/codestral-2508",
    temperature: 0.2,
  },
  {
    id: "koda/inception/mercury-edit-2",
  ...
  {
    // Same wire-level model as `koda/inception/mercury-edit-2`, but routed
    // through the koda Gateway's Next Edit endpoint instead of FIM. Picked by
    // users who want multi-line next-edit predictions with the jump-to-edit UX.
    id: "koda/inception/mercury-next-edit",
    ...
    temperature: 0,
    kind: "edit",
    fimModelID: "koda/inception/mercury-edit-2",
  },
  {
...
export const DEFAULT_AUTOCOMPLETE_PROVIDER_ID: AutocompleteProviderID = "koda"
...
export function getAutocompleteModel(provider?: string, model?: string): AutocompleteModelDef {
  // When provider is unset, always default to koda Gateway. Direct-provider
