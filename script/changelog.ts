...
Generates UPCOMING_CHANGELOG.md by running the koda changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for koda run (default: low)
      --quiet            Suppress koda command output unless it fails
...
const cmd = ["koda", "run"] // koda_change - opencode -> koda
